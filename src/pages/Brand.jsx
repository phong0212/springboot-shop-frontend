...
const Brand = () => {
    ...
    const { brandName } = useParams(); // <-- lấy brandName từ URL
    ...
    useEffect(() => {
        ...
        api.get(`/products/brands/${brandName}/products`, {
            params: { page, size: 12 }
        })
            .then(res => {
            ...
            .catch(err => {
                console.error("Lỗi khi load products theo brand:", err);
                setProducts([]);
            });
    }, [brandName, page]);
    return (
                            ...
                            <div className="shop-p__collection">
                                <div className="row is-grid-active">
                                    {products.length > 0 ? (
                                        ...
                                        <p>Không có sản phẩm nào thuộc brand này</p>
                                    )}
                                </div>
                            </div>
