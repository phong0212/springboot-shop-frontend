...
const Category = () => {
    ...
    const { categoryName } = useParams(); // <-- lấy brandName từ URL
    ...
    useEffect(() => {
        api
            .get(`/products/category/${categoryName}/products?page=${page}&size=12`)
            .then(res => {
                            ...
                            <div className="shop-p__collection">
                                <div className="row is-grid-active">
                                    {products.length > 0 ? (
                                        ...
                                        <p>Không có sản phẩm nào thuộc category này</p>
                                    )}
                                </div>
                            </div>
